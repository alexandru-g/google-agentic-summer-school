...
def post_support_reply(
    ...
    Use only after you have researched the answer with your own tools.
    Keep replies under ~1500 characters, cite your evidence (review ids,
    doc file names), and never discuss refunds — those go to humans.

    Args:
        team_name: Your team's short name — it prefixes the message.
